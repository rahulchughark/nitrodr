...
<div class="modal-dialog modal-dialog-centered modal-lg">
  ...
  <div class="modal-content">
    ...
    <?php
    echo $dataObj->getAllCategoriesTree();
    ?>
     
      <form action="#" method="post" class="form p-t-20 d-none" enctype="multipart/form-data">
        <!-- Section 1 -->
