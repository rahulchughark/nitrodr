...
<div class="main-content">
                        ...
                        <div class="card-body">
                            <div class="media bredcrum-title">
                                ...
                                <div class="media-body">
                                    ...
                                    <h4 class="font-size-14 m-0 mt-1">Fresh Daily Visits</h4>
                                </div>
                            </div>
    ...
    <script>
        $('#leads').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "get_dvr_admin.php", // json datasource
        ...
        //     "serverSide": true,
        //     "ajax": {
        //         url: "get_converted_visit_admin.php", // json datasource
        //         type: "post", // method  , by default get
        //         data: function(d) {
        //             d.d_from = "<?= htmlspecialchars($_GET['d_from'], ENT_QUOTES, 'UTF-8') ?>";
        //             d.d_to = "<?= htmlspecialchars($_GET['d_to'], ENT_QUOTES, 'UTF-8') ?>";
