    ...
    <div class="page-content">
                                ...
                                <div class="col-sm">
                                    <div class="media bredcrum-title">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <small class="text-muted">Home > Opportunity Renewals</small>
                                            <h4 class="font-size-14 m-0 mt-1">Search Opportunity Renewals <?= $_SESSION['user_type'] ?> </h4>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            $('#leads').DataTable({
                ...
                lengthMenu: [
                    [15, 25, 50, 100, 500, 1000, 5000, 10000, 15000, -1],
                    ['15', '25', '50', '100', '500', '1000', '5000', '10000', '15000', 'All']
                ],
                "processing": true,
                "serverSide": true,
                "ajax": {
            ...
            function clear_search() {
                window.location = 'admin_renewals.php';
            }
                        ...
                        success: function(res) {
                            ...
                            if (res == 'success') {
                                swal({
                                    ...
                                    $('#myModal1').modal('hide');
                                    var idss = "'but" + id + "'";
                                    var link = stage + ' <a href="javascript:void(0)" class="text-primary ml-2 stage-edit-link" title="Change Stage" id=but' + id + ' onclick="stage_change(' + idss + ',' + id + ')"><i class="fa fa-edit"></i></a>'
