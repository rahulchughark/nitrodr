...
<div class="clearfix"></div>
                            ...
                            $prepetual_query = billedAccountsPrepetual($_SESSION['team_id'],$dat);
                            ...
                            $annual_query = billedAccountsAnnual($_SESSION['team_id'],$dat);
...
<div class="table-responsive">							
                            <table class="table table-bordered mb-0"  width="50%"  align="center">
                                    <thead>
                                        <tr>
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="btn-group float-right" role="group" style="margin-top:12px;">
                                    ...
                                    <!-- <a href="export_oembilling.php?d_from=<?= @$_GET['d_from'] ?>&d_to=<?= @$_GET['d_to'] ?>">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right filter_wrap" role="menu">
                                            <form method="get" name="search" class="form-horizontal" role="form">
                                                ...
                                                <?php         
                                                    ...
                                                    $users = db_query("select id,name from users where status='Active' AND team_id=" . $_SESSION['team_id']);
                                                   ?>  
                                                <div class="form-group">
                                                  ...
                                                  <?php while ($users_data = db_fetch_array($users)) { ?>
                                                      <option value="<?= $users_data['id'] ?>" <?=(($_GET['users'] == $users_data['id'])? 'selected' : '') ?> ><?= $users_data['name'] ?></option>
                                                    <?php } ?>
                                                </select>
                                                </div>
        ...
        <script>
            ...
            $('#leads').DataTable({
                ...
                "serverSide": true, 
                "ajax": {
                    url: "get_billed_accounts.php", // json datasource
            ...
            function clear_search() {
                window.location = 'billed_accounts.php';
            }
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.dataTables_wrapper').height(wfheight - 445);
