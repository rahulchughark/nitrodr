...
include('includes/header.php');iss_dashboard();
...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            <?php
            if (($_SESSION['user_type'] == 'CLR' && $_SESSION['role'] == 'ISS') || $_SESSION['user_type'] == 'ISS MNGR') {
                ...
                if ($_SESSION['user_type'] == 'ISS MNGR') {
            ...
            ?>
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between dashboard-title-box">
                            <h4 class="mb-0 font-size-18">Corel ISS Dashboard</h4>
                ...
                <div class="row">
                    <?php if ($_SESSION['user_type'] == 'ISS MNGR') { ?>
                        <div class="col-xl-4">
                            <div class="card">
                                <div class="card-body dashboard-box-container">
                                    <h5 class="card-title mb-2">Monthly data counter (Only VAR Submission)</h5>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="table-responsive">
                                                <table class="table table-hover table-centered table-nowrap mb-0">
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                        $account = dataCounterISSMngr($date_from, $date_to, $iss_ids);
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td> <?= $i ?> </td>
                                                                <td><a target="_blank" href="orders_caller.php?counter=<?= $row['team_id'] ?>&d_from=<?= $date_from ?>&d_to=<?= $date_to ?>"><?= $row['r_name'] ?></a> </td>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="table-responsive">
                                                <table class="table table-hover table-centered table-nowrap mb-0">
                                                    ...
                                                    <tbody>
                                                        <?php $account =  dataCounterCaller($date_from, $date_to, $_SESSION['caller']);
                                                        //db_query("select o.r_name,count(o.id),IFNULL(sum(distinct(o.id)),0) from orders as o  left join tbl_lead_product as tp on o.id=tp.lead_id where (tp.product_type_id=1 or tp.product_type_id=2) and o.dvr_flag=0 and o.is_iss_lead = 0 and o.status='Approved' and o.license_type='Commercial' and date(o.approval_time)>='" . $date_from . "' and date(o.approval_time)<='" . $date_to . "' and o.caller=".$_SESSION['caller']." group by o.r_name");
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                <td> <?= $i ?> </td>
                                                                <td><a target="_blank" href="my_orders_caller.php?my=yes&counter=<?= $row['team_id'] ?>&d_from=<?= $date_from ?>&d_to=<?= $date_to ?>"><?= $row['r_name'] ?></a> </td>
                                                                <td> <?= $row['count(o.id)'] ?></td>
                                    ...
                                    <ul class="list-unstyled list-inline">
                                        <li class="list-inline-item px-3">
                                            <h5 class="text-warning mt-0">
                                                ...
                                                <?= getSingleresult("select count(distinct(o.id)) from orders as o left join tbl_lead_product as tp on o.id=tp.lead_id where (tp.product_type_id=1 or tp.product_type_id=2) and o.license_type='Commercial' and  o.stage NOT IN('Booking','OEM Billing','Closed Lost','Billed To Other Re-Seller','Hold License Certificate/Copy') and o.status='Approved' ".$contd." AND NOT EXISTS( SELECT a.pid,a.created_date FROM activity_log a WHERE a.pid=o.id $user_id and a.created_date >= DATE_SUB(CURDATE(), INTERVAL 7 DAY)) "); ?>
                                            </h5>
                                            <a target="_blank" href="orders_caller.php?untouched=7"><small class="font-size-14 text-muted">Last 7 Days</small></a>
                                        </li>
                                        <li class="list-inline-item px-3">
                                            <h5 class="text-warning mt-0">
                                                <?= getSingleresult("select count(distinct(o.id)) from orders as o left join tbl_lead_product as tp on o.id=tp.lead_id where (tp.product_type_id=1 or tp.product_type_id=2) and o.license_type='Commercial' and  o.stage NOT IN('Booking','OEM Billing','Closed Lost','Billed To Other Re-Seller','Hold License Certificate/Copy') and o.status='Approved' ".$contd." AND NOT EXISTS( SELECT a.pid,a.created_date FROM activity_log a WHERE a.pid=o.id $user_id and a.created_date >= DATE_SUB(CURDATE(), INTERVAL 15 DAY)) "); ?>
                                            </h5>
                                            <a target="_blank" href="orders_caller.php?untouched=15"><small class="font-size-14 text-muted">Last 15 Days</small></a>
                                        </li>
                                        <li class="list-inline-item px-3">
                                            <h5 class="text-warning mt-0">
                                                <?= getSingleresult("select count(distinct(o.id)) from orders as o left join tbl_lead_product as tp on o.id=tp.lead_id where (tp.product_type_id=1 or tp.product_type_id=2) and o.license_type='Commercial' and  o.stage NOT IN('Booking','OEM Billing','Closed Lost','Billed To Other Re-Seller','Hold License Certificate/Copy') and o.status='Approved' ".$contd." AND NOT EXISTS( SELECT a.pid,a.created_date FROM activity_log a WHERE a.pid=o.id $user_id and a.created_date >= DATE_SUB(CURDATE(), INTERVAL 30 DAY)) "); ?>
                                            </h5>
                                            <a target="_blank" href="orders_caller.php?untouched=30"><small class="font-size-14 text-muted">Last 30 Days</small></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-centered table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <?php
                                                    // print_r($iss_names);
                                                    if ($_SESSION['user_type'] == 'ISS MNGR' || $_SESSION['user_type']=='TEAM LEADER')
                                                    {
                                                        $account_lc = LCBDCounterMngr($date_from, $date_to, $iss_names);
                                                    } else {
                                                        $account_lc = LCBDCounterCaller($date_from, $date_to, $_SESSION['name']);
                                                    }
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td><?= $i ?></td>
                                                            <td><a target="_blank" href="orders_caller.php?lc_count=<?= $value['r_name'] ?>&d_from=<?= $date_from ?>&d_to=<?= $date_to ?>"><?= $value['r_name'] ?></a></td>
                                                ...
                                                <tbody>
                                                    <?php
                                                     ...
                                                     if($_SESSION['user_type'] == 'ISS MNGR' || $_SESSION['user_type']=='TEAM LEADER'){
                                                        ...
                                                        // print_r($res);
                                                        poaNeedMoreValidationMngr($iss_ids,$date_from, $date_to);
                                                    }else{ 
                                                        ...
                                                        <tr>                                                          
                                                            ...
                                                            <td><?php if($_SESSION['user_type'] == 'ISS MNGR' || $_SESSION['user_type']=='TEAM LEADER'){
                                                               // print_r("select count(DISTINCT(o.id)) from orders as o left join tbl_lead_product as tp on o.id=tp.lead_id left join activity_log a on o.id=a.pid left join callers c on c.id=o.caller where tp.product_type_id in (1,2) and o.license_type='Commercial' and a.is_intern=0 and a.action_plan='Turns Negative' and o.caller in (".$iss_ids.") and date(a.created_date)>='" . $date_from . "' and date(a.created_date)<='" . $date_to . "' group by a.pid ");
                                                                ...
                                                                echo poaTurnsNegative($_SESSION['caller'],$date_from, $date_to);
                                                            } ?>
                                                            </td>
                                                        </tr>
...
<?php
if (($_SESSION['user_type'] == 'CLR' && $_SESSION['role'] == 'ISS')) { ?>
...
<?php } else if ($_SESSION['user_type'] == 'ISS MNGR') { ?>
