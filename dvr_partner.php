...
<div class="main-content">
                                            ...
                                            ?>
                                                ...
                                                <div class="form-group">
                                                    <select name="users" class="form-control">
                                                        ...
                                                        <?php 
                                                        if($_SESSION['sales_manager'] == 1){
                                                            $query = db_query("select * from users where team_id in(" . $_SESSION['access'] . ") OR id=".$_SESSION['user_id']."");
                                                        }else{
                                                            $query = db_query("SELECT * FROM users WHERE team_id =" . $_SESSION['team_id'] . " and status='Active' ORDER BY name ASC");
                                                        }
    ...
    <script>
        $('#leads').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "get_visit_partner.php", // json datasource
        ...
        function clear_search() {
            window.location = 'dvr_partner.php';
        }
