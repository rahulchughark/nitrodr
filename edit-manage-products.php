...
if (isset($_POST['update_btn'])) {
    ...
    $res = db_query("UPDATE `tbl_main_product_opportunity` set `product_name`='" . $_POST['name'] . "', `description`='" . $_POST['desc'] . "', `status`='" . $_POST['status'] . "', `updated_at`=now() where id=" . $_GET['id']);
