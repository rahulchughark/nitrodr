...
if ($_REQUEST['edit_id']) {
    $sql = db_query("select * FROM learning_zone where status=1 and type='Video' and id=".$_REQUEST['edit_id']." ORDER BY id desc");
...
<div class="modal-dialog modal-dialog-centered">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title ">Edit Learning Zone </h4>
      ...
      <form action="#" method="post" class="form p-t-20" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="desc" value="<?= $description?>" required>
          </div>
