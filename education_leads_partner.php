    ...
    <div class="page-content">
                        ...
                        <div class="card-body">
                            <div class="media bredcrum-title"><img class="d-flex mr-3 rounded-circle avatar-xs" src="images/title-icon.png" alt=" ">
                                <div class="media-body">
                                    ...
                                    <small class="text-muted">Home >Education Leads</small>
                                    <h4 class="font-size-14 m-b-14 mt-1">Education Leads</h4>
                                </div>
                            </div>
        ...
        <script>
            ...
            $('#leads').DataTable({
                ...
                stateSave: true,
                "ajax": {
                    url: "get_education_leads_partner.php", // json datasource
            ...
            function clear_search() {
                window.location = 'education_leads_partner.php';
            }
