    ...
    <div class="page-content">
                                ...
                                <div class="col">
                                    <div class="media bredcrum-title"><img class="d-flex mr-3 rounded-circle avatar-xs" src="images/title-icon.png" alt=" ">
                                        <div class="media-body">
                                            ...
                                            <small class="text-muted">Home > Forecasting IsUpsell Report</small>
                                            <h4 class="font-size-14 m-0 mt-1">Forecasting IsUpsell Report</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-auto">
                                                        ...
                                                        <div class="form-group col-md-4 col-xl-3">
                                                            <select name="fin_year" class="form-control" id="fin_year">
                                                                <?php 
                                                                    ...
                                                                    if ($currentMonth >= 4) {
                                                                        $startYear = $currentYear + 1; // allow next financial year
                                                                    } else {
                                                                    ...
                                                                    ?>
                                                                        <option <?= (($_GET['fin_year'] ?? '') == $year ? 'selected' : '') ?>
                                                                            value="<?= $year ?>">
                                                                            <?= $year . "-" . $nextYearShort ?>
                                                                        </option>
                                                                    <?php } ?>
        ...
        <script>
            $('#leads').DataTable({
                ...
                "searching": false,
                "ajax": {
                    url: "ajax_isupsell_forcasting_data.php", // json datasource
