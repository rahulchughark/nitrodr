...
$sql = "select o.* ";
$sql.=" FROM orders as o $joinC where o.is_opportunity=1 and o.stage in ('Billing') ".$vir_cond.$Type;
...
$sql = "select o.* ";
$sql.=" FROM orders as o $joinC WHERE o.is_opportunity=1 and o.stage in ('Billing') ";
