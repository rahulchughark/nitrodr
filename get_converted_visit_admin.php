...
$sql = "select o.r_user,o.r_name,o.code,o.company_name,o.eu_email,o.parent_company,o.eu_mobile,o.id,o.created_date,o.status,o.lead_type,o.team_id,o.created_by,o.quantity,o.date_dvr,o.call_type,p.product_id,p.product_type_id,i.name as industry,o.dvr_by ";
$sql .= " FROM orders as o left join tbl_lead_product as p on o.id=p.lead_id left join industry as i on o.industry=i.id where o.license_type='Commercial' and o.dvr_by!=0 and o.is_dr=1 " . $dat;
//echo $sql; die;
$sql .= " GROUP BY o.id";
$query = db_query($sql);
