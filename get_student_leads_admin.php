...
$requestData['d_from'] = !empty($requestData['d_from']) ? date('Y-m-d', strtotime($requestData['d_from'])) : '';

$requestData['d_to'] = !empty($requestData['d_to']) ? date('Y-m-d', strtotime($requestData['d_to'])) : '';
...
// $condition1 = " and o.license_type = 'Education' and dvr_flag!=1 " .$dat;
// $sql = educationLeadQuery($condition1);
$sql = "select o.r_user,o.r_name,o.code,o.company_name,o.eu_email,o.parent_company,o.eu_mobile,o.id,o.created_date,o.status,o.partner_close_date,o.approval_time,o.prospecting_date,o.campaign_type,o.iss,o.lead_type,o.license_type,o.stage,o.team_id,o.caller,o.created_by,o.quantity,o.industry,o.sub_industry,o.runrate_key,o.os,o.close_time,o.dvr_flag,o.reason,o.source,o.association_name,o.product_type,o.data_ref ";
 $sql .= " FROM orders as o WHERE license_type='Student' AND o.dvr_flag!=1 ".$dat .$vir_cond;
...
$sql = "select o.r_user,o.r_name,o.code,o.company_name,o.eu_email,o.parent_company,o.eu_mobile,o.id,o.created_date,o.status,o.partner_close_date,o.approval_time,o.prospecting_date,o.campaign_type,o.iss,o.lead_type,o.license_type,o.stage,o.team_id,o.caller,o.created_by,o.quantity,o.industry,o.sub_industry,o.runrate_key,o.os,o.close_time,o.dvr_flag,o.reason,o.source,o.association_name,o.product_type,o.data_ref ";
 $sql .= " FROM orders as o WHERE license_type='Student' AND o.dvr_flag!=1 ";
