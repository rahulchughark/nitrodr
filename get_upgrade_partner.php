...
if ($requestData['untouched']) {
	...
	// select o.* from orders as o left join tbl_lead_product as tp on o.id=tp.lead_id where (tp.product_type_id=1 or tp.product_type_id=2 or tp.product_type_id=3) and o.license_type='Upgrade' and  o.stage NOT IN('Booking','OEM Billing','Closed Lost','Billed To Other Re-Seller','Hold License Certificate/Copy') and o.status='Approved' and o.quantity >= 3 ".$u_cond." AND NOT EXISTS( SELECT a.pid,a.created_date FROM activity_log a WHERE a.pid=o.id $caller_id $dat2) GROUP BY o.id ORDER BY o.id desc
	...
	$sql .= " FROM orders as o left join tbl_lead_product as p on o.id=p.lead_id where p.product_id = 1 and (p.product_type_id=1 or p.product_type_id=2) and o.is_iss_lead = 0 and o.dvr_flag=0 and o.status='Approved' AND o.stage NOT IN('Booking','OEM Billing','Closed Lost','Billed To Other Re-Seller','Hold License Certificate/Copy') $u_cond and o.license_type='Upgrade' and p.product_id!=' ' and o.team_id='" . $_SESSION['team_id'] . "' AND NOT EXISTS( SELECT a.pid,a.created_date FROM activity_log a WHERE a.pid=o.id $unCon) ";
} elseif ($requestData['score'] == 1) {

	$sql = "select o.r_user,o.r_name,o.code,o.company_name,o.eu_email,o.eu_mobile,o.id,o.created_date,o.status,o.partner_close_date,o.prospecting_date,o.campaign_type,o.iss,o.lead_type,o.license_type,o.stage,o.team_id,o.caller,o.created_by,o.quantity,o.industry,o.sub_industry,o.runrate_key,o.os,o.close_time,o.dvr_flag,o.reason,o.association_name,p.product_id,p.product_type_id ";
	$sql .= " FROM orders as o left join tbl_lead_product as p on o.id=p.lead_id where p.product_id = 1 and (p.product_type_id=1 or p.product_type_id=2) and o.is_iss_lead = 0 and o.dvr_flag=0 and o.license_type='Upgrade' and o.team_id='" . $_SESSION['team_id'] . "' and o.status='Approved' and date(o.approval_time)='" . $date . "'" . $dat . $u_cond;
	...
	$sql .= " from orders as o left join tbl_lead_product as tp on o.id=tp.lead_id where tp.product_id = 1 and (tp.product_type_id=1 or tp.product_type_id=2) and o.is_iss_lead = 0 and o.dvr_flag=0 and o.license_type='Upgrade' and o.team_id='" . $_SESSION['team_id'] . "' and MONTH(o.approval_time)='" . $dat1 . "' && YEAR(o.approval_time)='" . $dat2 . "'" . $dat . $u_cond;
} elseif ($requestData['stages']) {
	$sql = "select o.r_user,o.r_name,o.code,o.company_name,o.eu_email,o.eu_mobile,o.id,o.created_date,o.status,o.partner_close_date,o.prospecting_date,o.campaign_type,o.iss,o.lead_type,o.license_type,o.stage,o.team_id,o.caller,o.created_by,o.quantity,o.industry,o.sub_industry,o.runrate_key,o.os,o.close_time,o.dvr_flag,o.reason,o.association_name,p.product_id,p.product_type_id ";
	$sql .= " FROM activity_log as a left join orders as o on a.pid=o.id left join tbl_lead_product as p on o.id=p.lead_id where p.product_id = 1 and (p.product_type_id=1 or p.product_type_id=2) and o.is_iss_lead = 0 and o.dvr_flag=0 and o.license_type='Upgrade'  and o.team_id='" . $_SESSION['team_id'] . "' and MONTH(o.partner_close_date)=" . $dat1 . " and YEAR(o.partner_close_date)=" . $dat2 . "" . $dat . $u_cond;
} else {

	$sql = "select o.r_user,o.r_name,o.code,o.company_name,o.eu_email,o.eu_mobile,o.id,o.created_date,o.status,o.partner_close_date,o.prospecting_date,o.campaign_type,o.iss,o.lead_type,o.license_type,o.stage,o.team_id,o.caller,o.created_by,o.quantity,o.industry,o.sub_industry,o.runrate_key,o.os,o.close_time,o.dvr_flag,o.reason,o.association_name,p.product_id,p.product_type_id ";
	$sql .= " FROM orders as o left join tbl_lead_product as p on o.id=p.lead_id left join activity_log on o.id=activity_log.pid where o.is_iss_lead = 0 and o.dvr_flag=0 and o.license_type='Upgrade' and p.product_id!=' ' and o.team_id='" . $_SESSION['team_id'] . "' " . $dat;
}
$sql .= " GROUP BY o.id";
//echo $sql; die;
$query = db_query($sql);
...
if ($requestData['untouched']) {
	...
	$sql = "select o.r_user,o.r_name,o.code,o.company_name,o.eu_email,o.eu_mobile,o.id,o.created_date,o.status,o.partner_close_date,o.prospecting_date,o.campaign_type,o.iss,o.lead_type,o.license_type,o.stage,o.team_id,o.caller,o.created_by,o.quantity,o.industry,o.sub_industry,o.runrate_key,o.os,o.close_time,o.dvr_flag,o.reason,o.association_name,p.product_id,p.product_type_id ";
	$sql .= " FROM orders as o left join tbl_lead_product as p on o.id=p.lead_id left join activity_log on o.id=activity_log.pid WHERE o.is_iss_lead = 0 and o.dvr_flag=0  and o.license_type='Upgrade' and o.team_id='" . $_SESSION['team_id'] . "' ";
}
	...
	if ($data['status'] == 'Approved') {
		...
		if ($ncdate > $closeDate) {
			...
			if ($dayspassedafterExpired <= 30) {
				...
				// $daysLeft .= '<a href="javascript:void(0)" title="Re-Log"></a>';
				$check_valid = 1;
