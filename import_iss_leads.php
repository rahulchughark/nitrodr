...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title ">Import ISS Leads</h4>
        ...
        <div class="modal-body">
            ...
            <a href="uploads/iss_import_format.csv" download>Download CSV Format</a>
            <form action="#" method="post" class="form p-t-20" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" name="save_iss_csv" value="Save" class="btn btn-primary waves-effect waves-light m-r-10" />
