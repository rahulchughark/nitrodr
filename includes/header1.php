                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <?php if ($_SESSION['user_type'] == 'ADMIN' || $_SESSION['user_type'] == 'REVIEWER' || $_SESSION['user_type'] == 'SUPERADMIN' || $_SESSION['user_type'] == 'RADMIN' || $_SESSION['user_type'] == 'OPERATIONS') { ?>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark" href="" id="lead_notify" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-bell count"><p></p></i>
                                    <div class="notify"><p><?php getSingleresult("select count(id) from lead_notification where sender_type='Partner' and is_read=0") ? '<span class="heartbeat"></span>' : '' ?></p> </div>
                                </a>
                        ...
                        <?php } else if ($_SESSION['user_type'] == 'USR') { ?>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark" href="" id="lead_notify_usr" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-bell count_usr"><p></p></i>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <ul id="sidebarnav">
                        <?php if ($_SESSION['user_type'] == 'ADMIN' || $_SESSION['user_type'] == 'REVIEWER' || $_SESSION['user_type'] == 'SUPERADMIN' || $_SESSION['user_type'] == 'RADMIN') { ?>
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-chart-areaspline"></i><span class="hide-menu">Reports </span></a>
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <?php if ($_SESSION['user_type'] == 'RADMIN' || $_SESSION['user_type'] == 'REVIEWER' || $_SESSION['user_type'] == 'OPERATIONS' || $_SESSION['user_type'] == 'SUPERADMIN') { ?> <li> <a class="waves-effect waves-dark" href="log_report.php" aria-expanded="false"><span class="hide-menu">Call Logs Report</span></a> </li> <?php } ?>
                                    </ul>
                                </li>
                                
                              
                                    <?php if ($_SESSION['user_type'] == 'RADMIN' || $_SESSION['user_type'] == 'REVIEWER' || $_SESSION['user_type'] == 'OPERATIONS' || $_SESSION['user_type'] == 'SUPERADMIN' || $_SESSION['user_type'] == 'ADMIN') { ?><li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-chart-areaspline"></i><span class="hide-menu"> Review Reports </span></a>
                                            <ul aria-expanded="false" class="collapse">
                        ...
                        <?php if ($_SESSION['user_type'] == 'ADMIN' || $_SESSION['user_type'] == 'SUPERADMIN' || $_SESSION['user_type'] == 'RADMIN' || $_SESSION['user_type'] == 'OPERATIONS' ) { ?><li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu">Partners </span></a>
                                <ul aria-expanded="false" class="collapse">
                            ...
                            <?php if ($_SESSION['user_type'] == 'ADMIN' || $_SESSION['user_type'] == 'SUPERADMIN' || $_SESSION['user_type'] == 'RADMIN' || $_SESSION['user_type'] == 'OPERATIONS' ) { ?><li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu">Modules </span></a>
                                <ul aria-expanded="false" class="collapse">
