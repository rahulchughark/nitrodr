...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <?php if ($_SESSION['user_type'] == 'ADMIN') { ?>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark" href="" id="lead_notify" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-message count"></i>
                                    <div class="notify"> <?php getSingleresult("select count(id) from lead_notification where sender_type='Partner' and is_read=0") ? '<span class="heartbeat"></span>' : '' ?> <span class="point"></span> </div>
                                </a>
                        ...
                        <?php } else if ($_SESSION['user_type'] == 'USR') { ?>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark" href="" id="lead_notify_usr" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-message count_usr"></i>
                                    <div class="notify"> <?php getSingleresult("select count(id) from lead_notification where sender_type='Admin' and receiver_id =" . $_SESSION['user_id'] . " and is_read=0") ? '<span class="heartbit"></span>' : '' ?> <span class="point"></span> </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right mailbox scale-up">
                                    <ul>
                                        <li>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <ul id="sidebarnav">
                        <?php if ($_SESSION['user_type'] == 'ADMIN' && $_SESSION['user_id'] != '123') { ?>
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-chart-areaspline"></i><span class="hide-menu">Reports </span></a>
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <?php if ($_SESSION['sales_manager'] != 1) { ?> <li> <a class="waves-effect waves-dark" href="daily_report.php" aria-expanded="false"><span class="hide-menu">Daily Report</span></a> </li>
                                        ...
                                        <?php if ($_SESSION['user_id'] != 117) { ?> <li> <a class="waves-effect waves-dark" href="upgrade_considated_report.php" aria-expanded="false"><span class="hide-menu">Upgrade Report</span></a> </li> <?php } ?>
                                        ...
                                        <?php if ($_SESSION['user_id'] != 117) { ?> <li> <a class="waves-effect waves-dark" href="renew_report.php" aria-expanded="false"><span class="hide-menu">Renewal Stage Report</span></a> </li> <?php } ?>
                                    <?php } ?>
                                    <?php if ($_SESSION['user_id'] != 117) { ?> <li> <a class="waves-effect waves-dark" href="user_points.php" aria-expanded="false"><span class="hide-menu">Rewards Points</span></a> </li> <?php } ?>
                                    <?php if ($_SESSION['user_id'] != 117) { ?> <li> <a class="waves-effect waves-dark" href="upgrade_points.php" aria-expanded="false"><span class="hide-menu">Upgrade Rewards Points</span></a> </li> <?php } ?>
                                    <?php if ($_SESSION['user_id'] != 117) { ?> <li> <a class="waves-effect waves-dark" href="var_promo.php" aria-expanded="false"><span class="hide-menu">VAR Promo</span></a> </li> <?php } ?>
                                    ...
                                    <?php if ($_SESSION['user_id'] == 117 || $_SESSION['user_id'] == 123 || $_SESSION['user_id'] == 218 || $_SESSION['user_id'] == 12 || $_SESSION['user_id'] == 1) { ?> <li> <a class="waves-effect waves-dark" href="log_report.php" aria-expanded="false"><span class="hide-menu">Call Logs Report</span></a> </li> <?php } ?>
                                    <?php if ($_SESSION['user_id'] == 117 || $_SESSION['user_id'] == 123 || $_SESSION['user_id'] == 218 || $_SESSION['user_id'] == 12 || $_SESSION['user_id'] == 1) { ?><li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-chart-areaspline"></i><span class="hide-menu">Review Reports </span></a>
                                            <ul aria-expanded="false" class="collapse">
                        ...
                        <?php if ($_SESSION['user_type'] == 'USR' || $_SESSION['user_type'] == 'MNGR') {
                            if ($_SESSION['role'] != 'TC') { ?>
                                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-plus-circle"></i><span class="hide-menu">Create New </span></a>
                                    <ul aria-expanded="false" class="collapse">
                                        ...
                                        <li> <a class="waves-effect waves-dark" onclick="select_license()" href="javascript:void(0);" aria-expanded="false"><span class="hide-menu">Lead</span></a> </li>
                                        <li> <a class="waves-effect waves-dark" href="add_dvr.php" aria-expanded="false"><span class="hide-menu">DVR</span></a> </li>
                                    </ul>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($_SESSION['user_type'] == 'MNGR') { ?>
                                ...
                                <li> <a class="waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Statistics</span></a>
                                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php if ($_SESSION['user_type'] == 'ADMIN') { ?>
                            ...
                            <?php if ($_SESSION['user_id'] != 117 && $_SESSION['user_id'] != '123') { ?> <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-format-list-bulleted-type"></i><span class="hide-menu">Upgrade Leads </span></a>
                                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php if ($_SESSION['user_type'] == 'ADMIN' and ($_SESSION['user_id'] == 12 || $_SESSION['user_id'] == 218 || $_SESSION['user_id'] == 1)) { ?><li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu">Partners </span></a>
                                <ul aria-expanded="false" class="collapse">
                        ...
                        <?php if ($_SESSION['user_type'] == 'EM') { ?>
                            <li> <a class="waves-effect waves-dark" href="education_leads_admin.php" aria-expanded="false"><i class="mdi mdi mdi-library"></i><span class="hide-menu">Education/Renewal Leads</span></a> </li>
                            <li> <a class="waves-effect waves-dark" href="search_education_lead.php" aria-expanded="false"><i class="mdi mdi mdi-magnify"></i><span class="hide-menu">Search Education/Renewal Leads</span></a> </li>
        ...
        <div id="selfReview" class="modal modal_review" role="dialog">
