...
<body class="fix-header fix-sidebar card-no-border">
                       ...
                       <?php if($_SESSION['user_type']!='CLR') { ?><li class="nav-item ml-4 col-md-12"> 
                           <form action="global_search.php" method="GET">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="search" placeholder="" value="<?=$_REQUEST['search']; ?>">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-message"></i>
                                <div class="notify"> <?php /* (getSingleresult("select count(id) from notifications where (user_id='".$_SESSION['user_id']."' or role='".$_SESSION['user_type']."') and is_read=0 and status=1")?'<span class="heartbit"></span>':'') */ ?> <span class="point"></span> </div>
                            </a>
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                <h4><?=$_SESSION['name']?></h4>
                                                <p class="text-muted"><?=$_SESSION['email']?></p><a href="#" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
                ...
                <nav class="sidebar-nav">
                    ...
                    <?php if($_SESSION['user_type']=='ADMIN')
					   { ?>
                            ...
                            <?php } ?>
                            <?php if($_SESSION['user_id']!=117) { ?>  <li> <a class="waves-effect waves-dark" href="user_points.php" aria-expanded="false"><span class="hide-menu">User Points</span></a> </li> <?php } ?>
 ...
 <li> <a class="waves-effect waves-dark" href="call_quality.php" aria-expanded="false"><i class="mdi mdi-format-list-bulleted-type"></i><span class="hide-menu">Manage Call Quality</span></a> </li>
                       ...
                       <?php } ?>  
					 <li> <a class="waves-effect waves-dark" href="orders_caller.php" aria-expanded="false"><i class="mdi mdi-format-list-bulleted-type"></i><span class="hide-menu">Leads</span></a> </li>
                     ...
                     <li> <a class="waves-effect waves-dark" href="lead_action_list.php" aria-expanded="false"><i class="mdi mdi-hand-pointing-right"></i><span class="hide-menu"> Action List</span></a> </li>
						...
						<li> <a class="waves-effect waves-dark" href="add_leads.php" aria-expanded="false"><span class="hide-menu">Lead</span></a> </li>
                        ...
                        <li> <a class="waves-effect waves-dark" href="lapsed_leads.php" aria-expanded="false"><i class="mdi mdi-history"></i><span class="hide-menu">Lapsed Leads</span></a> </li>
						 ...
						 <?php if($_SESSION['user_id']!=117) { ?> <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-format-list-bulleted-type"></i><span class="hide-menu">Upgrade Leads </span></a>
						  <ul aria-expanded="false" class="collapse">
					   ...
					   <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-format-list-bulleted-type"></i><span class="hide-menu">Renewal Leads </span></a>
						...
						<?php if($_SESSION['sales_manager']!=1) { ?><li> <a class="waves-effect waves-dark" href="assign_renewal_leads.php" aria-expanded="false"><span class="hide-menu">Align Multiple Leads</span></a> </li>
						 ...
						 <?php } } ?>
                         <?php if($_SESSION['user_type']=='ADMIN' and ($_SESSION['user_id']==12 || $_SESSION['user_id']==1)) { ?><li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu">Partners </span></a>
						 <ul aria-expanded="false" class="collapse">
