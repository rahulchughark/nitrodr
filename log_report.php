                        ...
                        <div class="card-body">
                            ...
                            <div class="dropdown dropdown-lg">
                                ...
                                <div class="dropdown-menu1 dropdown-menu-right filter_wrap_2" id="filter-container" role="menu">
                                            ...
                                            <?php if ($_SESSION['user_type'] == 'OPERATIONS' || $_SESSION['user_type'] == 'SUPERADMIN' ||  $_SESSION['user_type'] == 'ADMIN' ||  $_SESSION['user_type'] == 'RADMIN' ||  $_SESSION['user_type'] == 'SALES MNGR') { ?>
...
<select class="form-control" id="quantity" name="quantity[]" data-live-search="true" multiple>
                                ...
                                <table id="leads" class="table display nowrap table-striped" data-height="wfheight" data-mobile-responsive="true" cellspacing="0" width="100%">
                                    <thead>
                                       <tr>
                                            ...
                                            <th>Submitted By</th>
                                            <th>Account Name</th>
                                            <?php if ($_SESSION['user_id'] == 'OPERATIONS' || $_SESSION['user_type'] == 'SUPERADMIN' || $_SESSION['user_id'] == 'ADMIN' || $_SESSION['user_id'] == 'SALES MNGR') { ?>
                                                <th>Lead Type</th>
                                            <?php } ?>
                                            <th>Caller Name</th>
                                            <th>Approval Date</th>
    ...
    <script>
        $('#leads').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "get_log_report.php", // json datasource
