...
<div class="main-content">
                                        ...
                                        <form method="get" name="search" id="search-form">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <select name="users" id="users" class="form-control">
                                                            ...
                                                            <?php
                                                            $res = db_query("select * from users where user_type='INTERN' and status='Active'");
    ...
    <?php
        ...
        if(count($call_type)>1){
            $call_subject_arr = implode('","',$call_type);
            //print_r($campaign_arr);die;
    ...
    <script>
        ...
        $('#visit_lac').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "get_calllogs_intern.php", // json datasource
        ...
        function clear_search() {
            window.location = 'logcall_interns.php';
        }
