                                ...
                                <div class="col-12 col-md">
                                    <div class="media bredcrum-title">
                                        ...
                                        <div class="media-body">
                                            <small class="text-muted">Home >Main Products</small>
                                            <h4 class="font-size-14 m-0 mt-1">Main Products</h4>
                                        </div>
                                    </div>
                                </div>

                                <div class="col-auto">
                                    <a href="add-main-product.php"><button title="Add Tag" class="btn btn-xs btn-light ml-1 waves-effect waves-light"><i class="ti-plus"></i></button></a>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="table display nowrap table-striped" data-height="wfheight" data-mobile-responsive="true" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 1;
                                        $productList = db_query("SELECT * FROM tbl_main_product_opportunity  order by id desc");
                                        ...
                                        ?>
                                            ...
                                            <tr id="tr-id-1" class="tr-class-1">
                                                ...
                                                <td><a class="btn btn-primary btn-xs px-2" href="edit-main-product.php?id=<?= $value['id'] ?>"><i style="font-size:16px" class="mdi mdi-pencil"></i></a></td>
                                            </tr>
                                        <?php $i++;
                                        } ?>
                                    </tbody>
