    ...
    <div class="page-content">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-auto">
                                    <div class="" role="group">
                                        ...
                                        <?php if ($_SESSION['user_type'] == 'SUPERADMIN' || $_SESSION['user_type'] == 'ADMIN') { ?>
                                            ...
                                            <a href="javascript:void(0);" onclick="show_import('all')"><button data-toggle="tooltip" data-placement="left" title="" data-original-title="Import Leads" class="btn btn-xs btn-light ml-1 waves-effect waves-light"><i class="ti-plus "></i></button></a>
                                            <a href="javascript:void(0);" onclick="show_import('partner')"><button data-toggle="tooltip" data-placement="left" title="" data-original-title="Import Partner Leads" class="btn btn-xs btn-light ml-1 waves-effect waves-light"><i class="ti-plus "></i></button></a>

                                        <?php }
                                        if ($_SESSION['user_type'] != 'OPERATIONS EXECUTIVE' && $_SESSION['user_type'] != 'ISS MNGR' && $_SESSION['download_status'] == 1) { ?>

                                            <!-- <a href="javascript:void(0);" id="sdfexport"><button data-toggle="tooltip" data-placement="left" title="" data-original-title="SFDC Export" class="btn btn-xs btn-light ml-1 waves-effect waves-light"><i class="ti-download"></i></button></a> -->
                                        ...
                                        <?php if($_SESSION['download_status'] == 1){ 
                                            ...
                                            ?>
                                        <a href="export_admin_lead.php?d_from=<?= @$_GET['d_from'] ?>&d_to=<?= @$_GET['d_to'] ?>&d_type=<?= @$_GET['dtype'] ?>&license='Fresh'&stage=<?= $stageStr ?>&partner=<?= $partnerStr ?>&tag=<?= $tagStr ?>">
                                            <button data-toggle="tooltip" data-placement="left" title="" data-original-title="Excel Export" class="btn btn-xs btn-light ml-1 waves-effect waves-light"><i class="ti-share"></i>
                                            </button>
                                        </a>
                                        <?php } ?>
                            ...
                            <?php } ?>
                            <?php if ($_GET['m'] == 'editlead') { ?>
                                <div class="alert alert-danger">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                                    <h3 class="text-danger"><i class="fa fa-check-circle"></i> Error!</h3> Please edit lead and fill all mandatory fields to update status!
                                </div>
                            <?php } ?>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.dataTables_wrapper').height(wfheight - 322);
