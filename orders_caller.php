                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="btn-group float-right" role="group" style="margin-top:12px;">
                                    <a href="export_callers_data.php?dtype=<?= @$_GET['dtype']?>&d_from=<?= @$_GET['d_from'] ?>&d_to=<?= @$_GET['d_to'] ?>&partner=<?= implode(',',@$_GET['partner']) ?>"><button data-toggle="tooltip" data-placement="left" title="" data-original-title="Export Leads" class="right-side bottom-right waves-effect waves-light btn-light btn btn-circle btn-xs pull-right m-l-10"><i class="ti-share"></i></button></a>
...
<script>
    $('#leads').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "get_orders_caller.php", // json datasource
    ...
    function clear_search() {
        window.location = 'orders_caller.php';
    }
