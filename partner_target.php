<?php include('includes/header.php'); protect_admin_page();
if(!$_GET['date_from'])
{
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Target VS Acivement</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                            <li class="breadcrumb-item active">Target VS Acivement</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Organization Target</h4>
								 ...
								 <div class="table-responsive m-t-40">
                                    <table id="" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										...
										<tr>  
                                               ...
                                               <td class="text-center"><?php $var=getSingleresult("select cdgs_target from partners where id=".$_SESSION['team_id'])*4;
                                                   if($var)
                                                   {
                                                       echo $var;
                                                   }
                                                  ...
                                                  <?php 
                                                  $achived=getSingleresult("select count(id) from orders where status='Approved' and stage in ('OEM Billing') and date(partner_close_date)>='".$_GET['date_from']."' and date(partner_close_date)<='".$_GET['date_to']."' ");
                                                  if($achived && $var) {
                                    ...
                                    <table id="" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                       ...
                                       while($users=db_fetch_array($sql_users))
										...
										<tr>  
                                                ...
                                                <td class="text-center"><?php $user_target=getSingleresult("select target from users_targets where type='USER' and user_id='".$users['id']."' and   team_id=".$_SESSION['team_id']);
                                                   $total_user_seats+=$user_target;
                                                   ?>
                                                  <form id="form_<?=$i?>" action="" method="post" >
                                                       <input type="number" id="user_target" value="<?=$user_target?>" required min="0" name="user_target" /><input type="button" onclick="validate_seats('<?=$i?>',<?=$var?>)" value="Save" class="btn btn-primary btn-xs" />
                                               ...
                                               <?php 
                                                  $achived=getSingleresult("select count(id) from orders where status='Approved' and stage in ('OEM Billing') and created_by='".$users['id']."' and date(partner_close_date)>='".$_GET['date_from']."' and date(partner_close_date)<='".$_GET['date_to']."' ");
                                    ...
                                    <h4 class="card-title">Month wise Target Vs. Achievment</h4>
                                    <div class="table-responsive m-t-40">
                                    <table id="" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
										...
										<tr>  
                                                ...
                                                <?php 
                                                  $achived_month=getSingleresult("select count(id) from orders where status='Approved' and stage in ('OEM Billing') and month(partner_close_date)='".$month."' and year(partner_close_date)='".date('Y')."'");
