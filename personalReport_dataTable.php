...
$d_from = mysqli_real_escape_string($GLOBALS['dbcon'], htmlspecialchars($_POST['d_from']));
$d_to = mysqli_real_escape_string($GLOBALS['dbcon'], htmlspecialchars($_POST['d_to']));
$d_type = mysqli_real_escape_string($GLOBALS['dbcon'], htmlspecialchars($_POST['date_type']));
...
<script>
    $('#leads').DataTable({
                ...
                "retrieve": true,
                "ajax": {
                    "url": "personalReport_ajax.php", // json datasource
