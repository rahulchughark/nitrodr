                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <select name="poa_stamped[]" class="multiselect_poa form-control" data-live-search="true" multiple>
                                                        <option value="Drop" <?= ((in_array('Drop',$poa_stamped)) ? 'selected' : '') ?>>Drop</option>
                                                        <option value="Need More Validation" <?= ((in_array('Need More Validation',$poa_stamped)) ? 'selected' : '') ?>>Need More Validation</option>
                                                        <option value="Turns Negative" <?= ((in_array('Turns Negative',$poa_stamped)) ? 'selected' : '') ?>>Turns Negative</option>
                                                        <option value="Need Visit" <?= ((in_array('Need Visit',$poa_stamped)) ? 'selected' : '') ?>>Need Visit</option>
                                                    </select>
                                                </div>
...
<script>
    $('#leads').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "get_poa_partner.php", // json datasource
    ...
    function clear_search() {
        window.location = 'poa_report_partner.php';
    }
