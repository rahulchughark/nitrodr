...
<div class="main-content">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="btn-group float-right" role="group" style="margin-top:12px;">
                                ...
                                <a href="export_qualified_accounts_admin.php?d_from=<?= @$_GET['d_from'] ?>&d_to=<?= @$_GET['d_to'] ?>&partner=<?= implode(',',@$partner) ?>&users=<?= implode(',',@$users) ?>&lead_type=<?= implode("','",@$lead_type) ?>&submission_type=<?= implode(',',@$submission_type) ?>&quantity=<?= implode(',',@$quantity) ?>&segment=<?=@$_GET['segment']?>">
    ...
    <script>
     $('#leads').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "get_qualified_accounts_admin.php", // json datasource
        ...
        function clear_search() {
            window.location = 'qualified_accounts_report_admin.php';
        }
