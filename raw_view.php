...
if ($_SESSION['user_type'] != 'ADMIN' && $_SESSION['user_type'] != 'SUPERADMIN' && $_SESSION['user_type'] != 'OPERATIONS' && $_SESSION['user_type'] != 'SALES MNGR' && $_SESSION['user_type'] != 'OPERATIONS EXECUTIVE' && $_SESSION['user_type'] != 'REVIEWER' && $_SESSION['user_type'] != 'CLR' && $_SESSION['user_type'] != 'ISS MNGR') {
...
if ($_POST['remarks']&& !$_POST['activity_edit']) {
    ...
    $res = db_query("insert into activity_log (pid,description,activity_type,call_subject,added_by) values ('" . $_POST['pid'] . "','" . htmlspecialchars($_POST['remarks'], ENT_QUOTES) . "','Raw','" . $_POST['call_subject'] . "','" . $_SESSION['user_id'] . "')");
}
                        ...
                        <div class="card-body">
                            ...
                            <div class="media ">
                                ...
                                <div class="media-body">
                                    ...
                                    <small class="text-muted">Home > View Raw Lead</small>
                                    <h4 class="font-size-14 m-0 mt-1">View Raw Lead</h4>
                                </div>

                                <?php if ($_SESSION['user_type'] != 'REVIEWER' && $_SESSION['user_type'] != 'CLR' && $_SESSION['user_type'] != 'ISS MNGR') { ?>
                                    <a href="#" id="addCopy" class="float-right" data-toggle="tooltip" data-placement="left" title="" data-original-title="Add as Fresh Lead">
                                        <button type="button" class="btn btn-xs  ml-1 waves-effect btn-primary waves-light" data-toggle="modal" data-original-title="Add as Fresh Lead" data-animation="bounce" data-target=".bs-example-modal-task" ><i class="ti-reload"></i></button></a>
                                <?php } ?>
                                <!-- <a href="#" id="addCopy"><button data-toggle="tooltip" data-placement="left" title="" data-original-title="Add as Fresh Lead" class="right-side bottom-right waves-effect waves-light btn-inverse btn btn-circle btn-md pull-right m-l-10"><i class="ti-reload text-white"></i></button></a> -->
...
<div class="clearfix"></div>
                                            ...
                                            <table class="table" id="user">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <?php if ($_SESSION['user_type'] == 'ADMIN' || $_SESSION['user_type'] == 'SUPERADMIN' || $_SESSION['user_type'] == 'OPERATIONS' || $_SESSION['user_type'] == 'SALES MNGR' || $_SESSION['user_type'] == 'CLR' || $_SESSION['user_type'] == 'ISS MNGR') {
                                                        $query = selectProduct('tbl_product');
                                                        }else{
                                            ...
                                            <table class="table" id="user">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td width="65%"><?= getSingleresult("select name from partners where id='" . $data['team_id'] . "'") ?></td>
                                                    </tr>
                                                    <tr>
   ...
   <div class="card mb-0 pt-2 shadow-none">
                                        ...
                                        <div id="collapseOne8" class="" aria-labelledby="headingOne8" data-parent="#accordionExample2">
                                            ...
                                            <div class="button-items1">
                                                <?php if ($created_by == $_SESSION['user_id']) { ?>
                                                    ...
                                                    <a href="edit_raw.php?eid=<?= $id ?>"><button type="button" class="btn1 btn-primary mt-2">Edit</button></a>

                                                <?php } else if ($_SESSION['user_type'] == 'SUPERADMIN' || $_SESSION['user_type'] == 'ADMIN' || $_SESSION['user_type'] == 'OPERATIONS' || $_SESSION['user_type'] == 'SALES MNGR' || $_SESSION['user_type'] == 'MNGR') { ?>
                                                    <a href="edit_raw.php?eid=<?= $id ?>"><button type="button" class="btn1 btn-primary mt-2">Edit</button></a>
                                                <?php } ?>
            ...
            <script>
                ...
                // function change_product_type(raw_id, type) {
...
//                 }
                ...
                $('.product_data').on('change', function() {
                    ...
                    if (productID) {                      
                        $.ajax({
                            ...
                            data: {product: productID,raw_id:raw_id,product_type:product_type},
                ...
                $(document).ready(function() {
                    ...
                    $('#addCopy').click(function() {
                        ...
                        if (p_name == 'Parallel') {
                            window.location = 'add_order_parallel.php?rid=' + leadId;
                        } else {
                            window.location = 'add_fresh_copy.php?rid=' + leadId;
                        }
