    ...
    <div class="page-content">
                        ...
                        <div class="card-body">
                            <div class="media bredcrum-title"><img class="d-flex mr-3 rounded-circle avatar-xs" src="images/title-icon.png" alt=" ">
                                <div class="media-body">
                                    ...
                                    <small class="text-muted">Home >Reviewed Account</small>
                                        ...
                                        <form method="get" name="search" class="form-horizontal" role="form">
                                            ...
                                            <?php if ($_SESSION['user_type'] != 'SALES MNGR') { ?>
                                                <div class="form-group">
                                                    ...
                                                    <select name="reviewer[]" id="reviewer" class="form-control" data-live-search="true" multiple>

                                                        <?php while ($row = db_fetch_array($res)) { ?>
                                                            <option <?= (in_array($row['name'], $reviewer) ? 'selected' : '') ?> value='<?= $row['name'] ?>'><?= $row['name'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            <?php } ?>
        ...
        <script>
            $('#leads').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: "get_review_report.php", // json datasource
            ...
            function clear_search() {
                window.location = 'review_report1.php';
            }
