    ...
    <div class="page-content">
                        ...
                        <div class="card-body">
                            <div class="media bredcrum-title"><img class="d-flex mr-3 rounded-circle avatar-xs" src="images/title-icon.png" alt=" ">
                                <div class="media-body">
                                    ...
                                    <small class="text-muted">Home >Review Vs Closure</small>
                                    <h4 class="font-size-14 m-0 mt-1">Review Vs Closure</h4>
                                </div>
                            </div>
                                ...
                                <div class="dropdown dropdown-lg">
                                    ...
                                    <div class="dropdown-menu1 dropdown-menu-right filter_wrap filter_wrap_2" id="filter-container" role="menu">
                                        ...
                                        <form method="get" name="search" class="form-horizontal" role="form">
                                            ...
                                            <div class="form-group">
                                                <?php if ($_GET['product']) { ?>
                                                    <select name="product_type[]" id="product_type" class="multiselect_type form-control" data-live-search="true" multiple>
        ...
        <script>
            $('#leads').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: "get_review_report2.php", // json datasource
                    type: "post", // method  , by default get
                    data: function(d) {
                        d.d_from = "<?= $_GET['d_from'] ?>";
                        d.d_to = "<?= $_GET['d_to'] ?>";
                        d.reviewer = "<?= $_GET['reviewer'] ?>";
            ...
            function clear_search() {
                window.location = 'review_report2.php';
            }
