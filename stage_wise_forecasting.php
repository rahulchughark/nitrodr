    ...
    <div class="page-content">
        ...
        <script>
            $('#leads').DataTable({
                ...
                "searching": false,
                "ajax": {
                    url: "get_stage_wise_forecasting.php", // json datasource
...
$(document).on('click', function (e) {
    ...
    const $filterBox = $('#filter-container');

    // If click is INSIDE filter container
    if ($filterBox.has(e.target).length) {

        // If click is NOT inside any bootstrap-select dropdown
        if (!$(e.target).closest('.bootstrap-select').length) {

            // Close all open selectpickers inside filter
