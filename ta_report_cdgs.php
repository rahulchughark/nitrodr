...
if($_SESSION['user_type']=='ADMIN' || $_SESSION['user_type']=='SUPERADMIN'|| $_SESSION['user_type']=='RADMIN'|| $_SESSION['user_type']=='OPERATIONS')
{
...
$sql = "select * ";
$sql.=" FROM orders where 1 and dvr_flag=0 and status='Approved' and stage in ('Commit','EU PO Issued','Booking','OEM Billing') ".$dat.$u_cond;
//echo $sql; die;
$query=db_query($sql);
