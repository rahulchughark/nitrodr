    ...
    <div class="page-content">
                        ...
                        <div class="card-body">
                            <div class="media bredcrum-title"><img class="d-flex mr-3 rounded-circle avatar-xs" src="images/title-icon.png" alt=" ">
                                <div class="media-body">
                                    ...
                                    <h4 class="font-size-14 m-0 mt-1">Upgrade Leads</h4>
                                </div>
                            </div>
                            ...
                            <div class="btn-group float-right" role="group" style="margin-top:12px;">
                                ...
                                <a href="export_admin_lead.php?d_from=<?= @$_GET['d_from'] ?>&d_to=<?= @$_GET['d_to'] ?>&dtype=<?= @$_GET['date_type'] ?>&license='Upgrade'">
        ...
        <script>
            $('#leads').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: "get_upgrade_leads_admin.php", // json datasource
            ...
            function clear_search() {
                window.location = 'upgrade_leads_admin.php';
            }
