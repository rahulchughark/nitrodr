        ...
        echo "<script>
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = 'view_opportunity.php?id=" . $_POST['lead_id'] . "';
                            }
                        });
                      </script>";
    }
    // redir("view_opportunity.php?id=" . $_POST['lead_id'], true);
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-auto <?= $data['kms_school_id'] ? '' : 'd-none'  ?>">
                                   <!-- $data['kms_school_id'] -->
                                   <a href="helpdesk.php?id=<?=$data['id']?>&school_id=<?=$data['kms_school_id']?>&type=opportunity" 
                                    ...
                                    '<?=$data['school_name']?>')" data-animation="bounce" data-target=".bs-example-modal-center"><button class="btn1 btn-primary mt-1">View Tickets </button></a> -->
                                </div>
                            </div>
                            ...
                            <div data-simplebar class="add_lead">
                                ...
                                <div class="accordion" id="accordionExample2">
                                    ...
                                    <div class="card mb-0 pt-2 shadow-none">
                                        ...
                                        <div class="card-header d-flex justify-content-between" id="headingOne6">
                                            ...
                                            <?php if ($fetch_query['edit_product']==1) { ?>
                                                <a class="flex-shrink-0 mr-5" data-toggle="modal" onclick="edit_opportunity(<?= $_GET['id'] ?>)" data-animation="bounce" data-target=".bs-example-modal-center"><button class="btn1 btn-primary mt-1 pull">Edit Opportunity</button></a>
                                            <?php } ?>
                                        </div>
                                        <div id="collapseOne6" class="" aria-labelledby="headingOne6" data-parent="#accordionExample2">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            <tbody>
                                                                ...
                                                                <?php $query = db_query("SELECT * FROM tbl_lead_product_opportunity where status=1 and lead_id =" . $_REQUEST['id']);
                                                                ...
                                                                <form action="#" method="post" id="poForm" name="saveform" enctype="multipart/form-data">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?= $expected_close_date ?>
                                                                            <?php 
                                                                            if($fetch_query['edit_date'] == 1 && $stage != 'PO/CIF Issued' && $stage !='Billing' && $agreement_type == 'Fresh') {  
                                    ...
                                    <div class="button-items1 text-center mt-2">
...
<script>
    ...
    function chage_stage(stage, id, ids, substage, payment_status, attachments, demo_datetime, academic_year) {
...
function edit_opportunity(lead_id) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            // Session expired → backend returns JSON
            if (typeof response === 'object' && response.code === 'SESSION_EXPIRED') {
                // window.location.href = 'index.php';
                Swal.fire("Error", "There was an error: " + response?.message, "error");
                return;
            }

            // If backend echoes JSON as string
            try {
